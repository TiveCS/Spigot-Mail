...
public class Mailbox {
    ...
    private List<Mail> inbox = new LinkedList<Mail>(), outbox = new LinkedList<Mail>();
    ...
    public void update(){
        ...
        try {
            if (useSql){
                ...
                while (result.next()){
                    ...
                    try{
                        ...
                        mail.setReceiver(new ArrayList<OfflinePlayer>());
                    ...
                    mail.setMessages(new ArrayList<String>());
                    try {
            ...
            System.out.println("Mailbox Failed [U: " + getPlayerData().getPlayer().getName() + "]");
